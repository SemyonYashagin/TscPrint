...
namespace TscDll.Helpers
{
    class SsccHelper
    {
        ...
        /// <param name="ssccList">Словарь sgtin-ов в формате "Номер партии+уник. номер - список sgtin-ов принадлежащих данной партии и уник. номеру"</param>
        ...
        public static void PrintSsccs(int width, int height, List<Tuple<string, string>> ssccList)
        {
            ...
            PointF point = new PointF(15, 15);//for number
